...
export default function Login() {
  ...
  //   try {
  //     const response = await fetch("https://unishop-fullstack-1.onrender.com/api/auth/google-login", {
  //       method: "POST",
  ...
  const handleGitHubLogin = () => {
    window.location.href = "https://unishop-fullstack-1.onrender.com/api/auth/github";
  };
