...
export default function Orders() {
  ...
  const fetchOrderHistory = async () => {
    try {
      const response = await axios.get("https://unishop-fullstack-1.onrender.com/history", {
        headers: {
  ...
  const trackOrderStatus = async (orderId) => {
    try {
      const response = await axios.get(`https://unishop-fullstack-1.onrender.com/track/${orderId}`, {
        headers: {
